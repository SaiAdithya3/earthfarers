  ...
  return (
    <div className="flex flex-col items-center w-full">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(to top, rgba(0, 0, 0, 1), rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.2), transparent), url('https://images.pexels.com/photos/28185416/pexels-photo-28185416/free-photo-of-a-large-container-yard-with-many-containers.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2')",
        }}
      >
        <motion.h1
      ...
      <div className="max-w-7xl px-6 w-full flex flex-wrap gap-10 mb-[100px]">
        {categories.map((category, index) => (
          <div
            key={index}
            className=" w-[48%] flex border border-black/30 p-6  rounded-3xl cursor-pointer hover:bg-zinc-400/10 transition-all overflow-hidden transform h"
          >
            <img
            ...
            <div className="px-6 flex flex-col items-start gap-3">
              ...
              <h3 className="text-4xl intern font-semibold mb-2">
                {category.title}
              </h3>
